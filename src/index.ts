 ...
 * (`merge`, `mergeArcs`, `neighbors`, `bbox`, …) but fetch only the
 * arc coord slices they need.
 *
...
// directly from build-time tools so client / worker bundles don't
// pull `fs` in transitively.
export {
  parseContainer,
  parseFooter,
  parseFrontHeader,
